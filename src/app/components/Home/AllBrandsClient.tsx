      ...
      <div className="mx-auto w-full max-w-[1170px] px-3 py-5 sm:px-4 md:px-0">
        <nav className="mb-3">
          <div className="hidden md:flex flex-wrap items-center gap-2 text-sm roboto-sans-font">
            ...
            <span className="text-[#ff6900] text-[11px]">All Brands</span>
          </div>
        </nav>
              ...
              {pageItems.map((brand) => (
                <div key={brand.id} className="min-w-0 w-full md:w-[226px]">
                  <Link
                    ...
                    className="group block w-full focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ff6900] focus-visible:ring-offset-2 md:w-[226px]"
                  >
                  ...
                  {pages.map((p) => (
                    <button
                      ...
                      className={cn(
                        ...
                        page === p
                          ? "border-[#ff6900] text-[#ff6900] bg-white"
