    ...
    <div className="bg-[#F2F2F2] rounded shadow hover:shadow-md transition flex flex-col h-full">
      ...
      <div className="px-3 pb-3 flex flex-col flex-1">
        <Link href={`/brand/${brandSlug || ""}`}>
          <p className="text-[1rem] text-gray-500 hover:text-[#ff6900]" style={{ fontFamily: '"Roboto Condensed"' }}
          >{brandName}</p>
        </Link>
        <p className="text-[1rem] text-gray-400 mb-1 hover:text-[#ff6900]" style={{ fontFamily: '"Roboto Condensed"' }}>
          Sku: {product.sku}
        </p>
        <Link href={`${product?.productUrl}`}>
          <p className="text-[14px] font-medium mb-1 line-clamp-2 hover:text-[#ff6900]" style={{ fontFamily: '"Roboto Condensed"' }}>
            {productName}
          </p>
        </Link>
        ...
        {!availableForSale ? <div className="flex flex-col items-start gap-2 mb-2">
          <>
            ...
            {/* New Price */}
            <span className="text-[1rem] font-bold  " style={{ fontFamily: '"Roboto"' }}>Call for pricing:<Link href="tel:+15022063033" className="text-[#ff6900] underline">
              {/* (502) 206-3033 */}
            </Link></span>
          </>
        ...
        <button
          ...
          className="w-full bg-[#CAC9C9] hover:bg-[#ff6900] font-bold text-[#393939] border-b-2 border-[#393939] py-1 hover:text-white rounded text-[14px] mt-auto transition">
          {"ADD TO CART"}
        </button>
      </div>
    </div>
