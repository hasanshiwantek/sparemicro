    ...
    <div className="bg-[#F2F2F2] rounded transition flex flex-col h-full">
      ...
      >
        <Link href={`/brand/${brandSlug || "/"}`}>
          <span className="text-[12px] text-[#7B7B7B] hover:text-[#ff6900]" style={robotoCondensedStyle}
          >{brandName} </span>
        </Link>
        <p className="text-[1rem] text-gray-400 mb-1 hover:text-[#ff6900]" style={robotoCondensedStyle}>
          Sku: {product.sku}
        </p>
        <Link href={product?.productUrl || "/"}>
          <span className="text-[14px] font-bold mb-1 text-[#545454] line-clamp-2 hover:text-[#ff6900]" style={robotoCondensedStyle}>
            {productName}
          </span>
        </Link>
