              ...
              <div className="flex flex-col xl:flex-row items-center xl:w-[65.1%] 2xl:w-[64.5%]">
                ...
                <div className="w-full text-[15px] xl:w-[63.1%] 2xl:w-[71%] mx-4">
                  ...
                  <Link href={`${item?.productUrl || "#"}`}>
                    <p className=" text-[#ff6900] underline text-center lg:mx-auto md:mx-auto sm:mx-auto w-[100%] sm:w-[60%]  md:w-[70%] lg:w-[80%] xl:text-start xl:w-[100%] 2xl:w-[100%]">
                      {item.name}
                    </p>
                  </Link>
    ...
    "
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <button
                    ...
                    className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#CAC9C9] text-[#ff6900] transition hover:bg-[#B8B7B7] hover:text-[#b81a1a]"
                  >
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        ...
        >
          <div className="bg-white px-6 py-12 sm:px-10 sm:py-14 text-center">
            <div className="mx-auto mb-6 flex h-28 w-28 items-center justify-center rounded-full border-4 border-[#ff6900]">
              <span className="text-6xl font-extrabold leading-none text-[#ff6900]">
                !
              </span>
            </div>
            ...
            <div className="mt-6 flex items-center justify-center gap-4">
              <button
                ...
                className="min-w-[85px] bg-[#ff6900] px-10 py-3 text-xl font-bold text-white hover:bg-[#b81a1a] transition border-b border-black"
              >
                OK
              </button>
              <button
                ...
                className="min-w-[123px] bg-[#ff6900] px-10 py-3 text-xl font-bold text-white hover:bg-[#b81a1a] transition border-b border-black"
              >
                CANCEL
              </button>
            </div>
