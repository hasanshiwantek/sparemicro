        ...
        <div className="text-sm text-gray-700 space-y-2 mb-2">
          ...
          <div className="flex justify-between py-2">
            ...
            >
              ...
              <span
                className={
                  shippingCost
                    ? "text-[14px] text-[#ff6900] border-b border-red-500 inline-block cursor-pointer"
              ...
              <span
                className={
                  showShipping
                    ? " text-[14px]  border-b hover:border-red-500 border-gray-500 inline-block cursor-pointer italic hover:text-[#ff6900]"
                    : "hover:border-red-500 hover:text-[#ff6900] text-[14px] border-b border-gray-500 inline-block cursor-pointer"
                }
                onClick={() => setShowShipping(!showShipping)}
              >
          ...
          {showShipping && (
            ...
            >
              ...
              <div className="flex justify-end">
                ...
                // className="w-full md:w-[65%] p-2 border-b border-black  bg-[#ff6900] text-white text-[14px] font-bold"
                >
          ...
          {appliedCoupon && (
            <div className="flex gap-3 items-center rounded">
              ...
              <button
                ...
                className=" text-[14px] underline text-[#ff6900] hover:text-red-700"
              >
                Remove
              </button>
            </div>
          ...
          {showCoupon && !appliedCoupon && (
            ...
            >
              ...
              <button
                type="submit"
                className="border-b border-black px-12 rounded bg-[#ff6900] text-white text-[14px] font-bold disabled:opacity-50"
                disabled={couponLoading}
              >
                {couponLoading ? "..." : "Apply"}
              </button>
