            ...
            <div className="flex items-center md:justify-end justify-between whitespace-nowrap flex-1 gap-5 md:gap-5">
              ...
              <div className="relative sm:flex hidden" ref={dropdownRef}>
                <div className="relative w-[40px]">
                  <div className="absolute z-[9999] -top-6 -bottom-7 right-0 left-0 bg-[#ff6900] hover:bg-[#860d09] border-0 border-b-[3px] border-b-[#860109] transition cursor-pointer flex items-center justify-center"
                      ...
                      {cart.length === 0 ? (
                        ...
                        <div className="relative">
                          ...
                          <div className="flex gap-2 p-4 pt-6">
                            <button
                              className="flex-1 font-[var(--font-roboto-condensed)] font-bold bg-[#ff6900] hover:bg-[#b81818] text-white text-[1rem] py-2.5 px-4 border-0 border-b-[3px] border-b-[#860109] transition uppercase tracking-wide"
              ...
              <div className="relative top-[3px] z-[999] sm:hidden flex" >
                <Link href="/cart" className="transition block">
                  <div className="bg-[#ff6900] p-2 rounded hover:bg-red-700 transition">
                    <FaShoppingCart className="w-7 h-7 text-white" />
