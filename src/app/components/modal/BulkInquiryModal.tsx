      ...
      <DialogContent className="!max-w-[65rem] w-full max-h-[100vh] overflow-y-auto p-0 rounded-lg shadow-sm">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-3/5 p-8 bg-white relative flex flex-col items-center">
            ...
            <div style={{ borderRadius: "49% 51% 51% 49% / 0% 0% 50% 50%" }} className="absolute top-0 right-0 bg-[#ff6900] text-white px-6 py-5 w-full flex justify-center items-center">
            ...
            <form onSubmit={handleSubmit} className="mt-16 w-full space-y-4">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full bg-[#ff6900] border-b border-black text-white px-6 py-5 text-2xl rounded-md font-medium hover:bg-[#d94d30] transition-colors duration-200"
              >
