  ...
  return (
    <div className="w-[80%]  max-w-full lg:max-w-[1170px]  mx-0 lg:mx-auto  lg:px-[0%] px-[7%] ">
      ...
      <div className="mb-8">
        ...
        <h2 className="sm:text-[28px] h1-lg ">Spare Micro </h2>
      </div>
