          ...
          <div className="w-full min-w-0 max-w-[585px] text-left">
            <nav className="mb-5 w-full">
              <div className="flex flex-wrap items-center gap-2 text-sm">
                ...
                <span className="text-[#eb6302]">Forgot Password</span>
              </div>
            </nav>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full">
              <div className="flex flex-col gap-2">
                ...
                {errors.email && (
                  <p className="text-sm text-[#eb6302]">{errors.email.message}</p>
                )}
              </div>
            </form>
            ...
            <p className="mt-8 text-sm text-gray-600">
              <Link
                href="/auth/login"
                className="text-[#eb6302] underline decoration-[#eb6302] underline-offset-2 hover:opacity-90"
              >
                Back to login
              </Link>
            </p>
