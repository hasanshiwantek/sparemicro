    ...
    <div className="">
      ...
      <div className="  md:px-10 xl:px-0  w-full  xl:max-w-[1170px] 2xl:max-w-[1170px] max-w-7xl mx-auto py-4">
        <div className="hidden md:flex items-center gap-2 text-sm mb-2">
          ...
          <span className="text-[#ff6900]">Create Account</span>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
            ...
            <div>
              ...
              />
              {errors.email && (
                <p className="mt-1 text-[14px] text-[#ff6900]">
            ...
            <div>
              ...
              {errors.country && (
                <p className="mt-1 text-[14px] text-[#ff6900]">Country is required</p>
              )}
            </div>
          ...
          <div className="w-full md:max-w-[calc(50%-1rem)]">
            ...
            />
            {errors.zip && (
              <p className="mt-1 text-[14px] text-[#ff6900]">{errors.zip.message}</p>
            )}
          </div>
          <div className="mt-6">
            <ReCAPTCHA
