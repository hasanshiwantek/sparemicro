...
export default function OrderSuccessPage() {
  ...
  //         <Link href="/cart">
  //           <button className="mt-4 bg-red-500 hover:bg-[#ff6900] text-white font-semibold py-2 px-6 rounded-full">
  //             Go to Shop
  //           </button>
  //         </Link>
  //       </div>
  ...
  //             className="bg-red-500 hover:bg-[#ff6900] text-white font-semibold py-3 px-8 rounded-full transition-colors"
  //           >
  //             Check Your Orders
  //           </button>
  //         </div>
