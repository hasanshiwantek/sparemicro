        ...
        <>
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col">
              <label
                ...
                className={cn(
                  "mb-2 text-base",
                  errors.billingFirstName ? "text-[#ff6900]" : "text-gray-700"
                )}
              >
                First Name
              </label>
            ...
            <div className="flex flex-col">
              <label
                ...
                className={cn(
                  "mb-2 text-base",
                  errors.billingLastName ? "text-[#ff6900]" : "text-gray-700"
                )}
              >
                Last Name
              </label>
          ...
          <div className="flex flex-col">
            <label
              ...
              className={cn(
                "mb-2 text-base",
                errors.billingAddress1 ? "text-[#ff6900]" : "text-gray-700"
              )}
            >
              Address Line 1
            </label>
          ...
          <div className="flex flex-col">
            <label
              ...
              className={cn(
                "mb-2 text-base",
                errors.billingCity ? "text-[#ff6900]" : "text-gray-700"
              )}
            >
              City
            </label>
          ...
          <div className="flex flex-col">
            <label
              ...
              className={cn(
                "mb-2 text-base",
                errors.billingCountry ? "text-[#ff6900]" : "text-gray-700"
              )}
            >
              Country
            </label>
          ...
          /> */}
            ...
            <div className="flex flex-col">
              <label
                ...
                className={cn(
                  "mb-2 text-base",
                  errors.billingZip ? "text-[#ff6900]" : "text-gray-700"
                )}
              >
                Postal Code
              </label>
