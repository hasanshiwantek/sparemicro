    ...
    <div className="w-full space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="w-full">
          ...
          />
          {errors.firstName && (
            <p className="text-[#ff6900] text-sm mt-1">{errors.firstName}</p>
          )}
        </div>
        ...
        <div className="w-full">
          ...
          />
          {errors.lastName && (
            <p className="text-[#ff6900] text-sm mt-1">{errors.lastName}</p>
          )}
        </div>
      </div>
      ...
      <div className="w-full block">
        ...
        />
        {errors.email && (
          <p className="text-[#ff6900] text-sm mt-1">{errors.email}</p>
        )}
      </div>
      ...
      <div className="!w-full block">
        ...
        />
        {errors.password && (
          <p className="text-[#ff6900] text-sm mt-1">{errors.password}</p>
        )}
      </div>
