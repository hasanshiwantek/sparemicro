        ...
        <div className="flex justify-between items-center">
          ...
          {cart?.reduce((sum, item) => sum + (item.quantity || 1), 0) > 1 && (
            <button
              ...
              className="text-[13px] text-[#ff6900] hover:underline font-medium"
            >
              {isMultiAddress
              ...
              <>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col">
                    <label
                      ...
                      className={cn(
                        "mb-2 text-base",
                        errors.firstName ? "text-[#ff6900]" : "text-[#545454]",
                      )}
                    >
                      First Name
                    </label>
                    ...
                    />
                    {errors.firstName && (
                      <p className="text-sm text-[#ff6900] mt-1">
                  ...
                  <div className="flex flex-col">
                    <label
                      ...
                      className={cn(
                        "mb-2 text-base",
                        errors.lastName ? "text-[#ff6900]" : "text-[#545454]",
                      )}
                    >
                      Last Name
                    </label>
                ...
                <div className="flex flex-col mt-4">
                  <label
                    ...
                    className={cn(
                      "mb-2 text-[13px]",
                      errors.address1 ? "text-[#ff6900]" : "text-[#545454]",
                    )}
                  >
                    Address Line 1
                  </label>
                ...
                <div className="flex flex-col mt-4">
                  <label
                    className={cn(
                      "mb-2 text-[13px]",
                      errors.city ? "text-[#ff6900]" : "text-[#545454]",
                    )}
                  >
                    City
                  </label>
                ...
                <div className="flex flex-col mt-4">
                  <label
                    ...
                    className={cn(
                      "mb-2 text-base",
                      errors.country ? "text-[#ff6900]" : "text-[#545454]",
                    )}
                  >
                    Country
                  </label>
                  ...
                  <div className="flex flex-col ">
                    <label
                      ...
                      className={cn(
                        ...
                        errors.state ? "text-[#ff6900]" : "text-[#545454]",
                      )}
                    >
          ...
          <div>
            <h3
              className={cn(
                ...
                errors.shippingMethod ? "text-[#ff6900]" : "text-[#545454]",
              )}
            >
              Shipping Method
            </h3>
            ...
            {errors.shippingMethod && (
              <p className="text-sm text-[#ff6900] mt-2">
