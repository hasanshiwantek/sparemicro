  ...
  return (
    <div className="max-w-full mx-auto">
      <div className=" rounded-xl w-full px-0">
        ...
        >
          <h2>
            <Link href={"/"} className="text-[12px] hover:!text-[#ff6900] roboto-sans-font" itemProp="name " >
              Home
            </Link>
            ...
            {product?.categoryHierarchy?.map((cat: any, index: number) => (
              <span key={cat.id}>
                ...
                <Link href={`/category/${cat?.slug}`}
                  className={`text-[11px]   hover:!text-[#ff6900] roboto-sans-font`}
            ...
            <Link href={product?.productUrl} className="text-[12px] !text-[#ff6900] roboto-sans-font" itemProp="name" >
              {product?.name}
            </Link>
