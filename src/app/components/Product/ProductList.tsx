...
export default function ProductList({
  ...
  return (
    ...
    `}</style>
        ...
        <div className="my-6 ">
          <div className="grid grid-cols-2 md:grid-cols-4">
            <Link
              ...
              className="py-3 px-4 text-center text-[14px] text-[#545454] font-bold  hover:text-[#ff6900] transition-colors"
            >
              {categories?.name}
            </Link>
      ...
      {/* Error State */}
      {error && (
        <div className="mt-6 text-center text-[#ff6900] font-medium">
