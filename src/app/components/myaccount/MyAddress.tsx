  ...
  />
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-10">
            <Button
              ...
              disabled={loading}
              className="w-full md:w-[16%] !p-7 text-2xl border-b-2 border-black bg-[#ff6900] text-white font-bold"
            >
              {loading ? "UPDATING..." : "UPDATING ADDRESS"}
            </Button>
            <Button
              onClick={() => setShowModal(false)}
              className="w-full md:w-36 !p-7 text-2xl border-b-2 border-black bg-[#ff6900] font-bold text-white transition"
            >
              CANCEL
            </Button>
          </div>
        ...
        <>
          ...
          {error && (
            <p className="text-[#ff6900]">Failed to fetch address. {error}</p>
          )}
          ...
          {!loading && !error && (
            ...
            >
                ...
                >
                  ...
                  <div className="flex gap-2 mt-auto">
                    ...
                    <button
                      ...
                      className="w-50 px-4 py-3 rounded-none text-2xl font-bold bg-[#ff6900] text-white border-b-2 border-black transition"
                    >
                      Edit
                    </button>
              ...
              <div className="border border-gray-400 rounded-lg p-6 flex flex-col items-center justify-center h-[235px] hover:bg-gray-50 cursor-pointer">
                ...
                >
                  <Plus size={44} className="text-[#ff6900]" />
