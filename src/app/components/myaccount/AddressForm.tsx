      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            />
            {errors.firstName && (
              <p className="text-sm text-[#ff6900]">{errors.firstName.message}</p>
            )}
          </div>
          <div>
            <Label
            ...
            />
            {errors.lastName && (
              <p className="text-sm text-[#ff6900]">{errors.lastName.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            />
            {errors.phone && (
              <p className="text-sm text-[#ff6900]">{errors.phone.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            />
            {errors.address1 && (
              <p className="text-sm text-[#ff6900]">{errors.address1.message}</p>
            )}
          </div>
          <div>
            <Label
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            />
            {errors.suburb && (
              <p className="text-sm text-[#ff6900]">{errors.suburb.message}</p>
            )}
          </div>
          <div>
            <Label
            ...
            {errors.country && (
              <p className="text-sm text-[#ff6900]">{errors.country.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            {errors.state && (
              <p className="text-sm text-[#ff6900]">{errors.state.message}</p>
            )}
          </div>
          <div>
            <Label
            ...
            />
            {errors.postcode && (
              <p className="text-sm text-[#ff6900]">{errors.postcode.message}</p>
            )}
          </div>
        </div>
        ...
        >
          <Button
            type="submit"
            className="w-full md:w-[16%] !p-7 text-2xl rounded-none border-b-2 border-black bg-[#ff6900] text-white font-bold"
          >
          ...
          <Button
            onClick={() => router.back()}
            type="button"
            className="w-full md:w-36 !p-7 text-2xl border-b-2 border-black rounded-none bg-[#ff6900] font-bold text-white transition"
          >
            CANCEL
          </Button>
        </div>
