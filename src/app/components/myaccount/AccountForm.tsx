      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
          <div>
            ...
            />
            {errors.firstName && <p className="text-sm text-[#ff6900]">{errors.firstName.message}</p>}
          </div>
          <div>
            ...
            <Input
              ...
              className={inputClass}
            />
            {errors.lastName && <p className="text-sm text-[#ff6900]">{errors.lastName.message}</p>}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-[20px]">
          <div>
            ...
            <Input
              ...
              className={inputClass}
               disabled
            />
            {errors.email && <p className="text-sm text-[#ff6900]">{errors.email.message}</p>}
          </div>
          ...
          <div className="relative">
            ...
            {errors.password && <p className="text-sm text-[#ff6900]">{errors.password.message}</p>}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-[20px]">
          <div className="relative">
            ...
            {errors.password_confirmation && <p className="text-sm text-[#ff6900]">{errors.password_confirmation.message}</p>}
          </div>
        ...
        {/* Submit */}
        <Button type="submit" className=" w-full mt-[12px] md:w-64 !p-7 text-2xl rounded-none border-b-2 border-black bg-[#ff6900] text-white font-bold md:mt-8 " >
