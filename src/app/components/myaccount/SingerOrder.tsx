  ...
  if (error || !order) {
    return (
      <div className="py-6 max-w-full mx-auto">
        <div className="border rounded-md p-6 text-center text-[#ff6900]">
      ...
      <div className="py-6 max-w-full mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="border rounded-md p-4 text-xl">
            ...
            <button onClick={() => handlePrint()} className="mt-3 text-2xl font-bold border-b-2 border-black px-4 py-2 bg-[#ff6900] text-white rounded-md hover:bg-red-700 transition w-60">
              PRINT INVOICE
            </button>
