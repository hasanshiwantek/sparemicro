          ...
          <div>
            ...
            <ul className="space-y-1 text-[14px] lg:text-[12px] text-[#ffffff]">
              {!auth?.isAuthenticated ? (
                <li>
                  <Link href="/auth/login" className="hover:text-[#ff6900]">
                    Login
                  </Link>{" "}
                  or{" "}
                  <Link href="/auth/signup" className="hover:text-[#ff6900]">
                    Sign Up
                  </Link>
                </li>
              ) : (
                <>
                  ...
                  <li>
                    <span
                      ...
                      className="hover:text-[#ff6900] cursor-pointer"
                    >
                      Logout
                    </span>
                  </li>
          ...
          <div>
            ...
            <ul className="space-y-1 text-[14px] lg:text-[12px] text-[#ffffff]">
              {loading ? (
                ...
                <li className="text-[#ff6900] px-2 py-1">{error}</li>
              ) : blogPosts.length === 0 ? (
                ...
                blogPosts.map((post: any) => (
                  <li key={post.id}>
                    <Link
                      ...
                      className="hover:text-[#ff6900] text-[12px] roboto-font"
                    >
                      {post.title}
                    </Link>
                  </li>
            ...
            <div className=" md:mt-8">
              ...
              <div className="flex justify-center md:justify-start gap-3">
                {/* <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Visit Spare Micro on Facebook (opens in new tab)"
                ...
                <Link
                  ...
                  rel="noopener noreferrer"
                  className="hover:opacity-80"
                  aria-label="Visit Spare Micro on LinkedIn (opens in new tab)"
                >
                  <svg
                    className="w-8 h-8 text-[#ffffff]"
                    fill="currentColor"
      ...
      <div className="bg-[#545454]  py-4">
        <div className="w-full xl:max-w-[1170px] 2xl:max-w-[1170px] mx-auto px-4 xl:px-4 2xl:px-2 ">
          <p className="text-[#ffffff] text-[12px] text-left text-base">
            © {new Date().getFullYear()} Spare Micro |&nbsp;
            <Link href="/sitemap" className="hover:text-[#ff6900]">
              Sitemap
            </Link>
          </p>
        </div>
