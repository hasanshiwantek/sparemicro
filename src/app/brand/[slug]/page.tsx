...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: ` https://sparemicro.vercel.app/brand/${slug}`,
    },
    openGraph: {
      title,
      description,
      url: ` https://sparemicro.vercel.app/brand/${slug}`,
      siteName: "Spare Micro",
      images: [
        {
          url: " https://sparemicro.vercel.app/images/products-og.jpg", // Update with actual OG image
          width: 1200,
          height: 630,
