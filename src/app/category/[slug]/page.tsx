...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: ` https://sparemicro.vercel.app/category/${slug}`,
    },
    openGraph: {
      title,
      description,
      url: ` https://sparemicro.vercel.app/category/${slug}`,
      siteName: "Spare Micro",
      images: [
        {
          url: " https://sparemicro.vercel.app/images/products-og.jpg", // Replace with actual OG image
          width: 1200,
          height: 630,
